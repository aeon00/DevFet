...
# plt.xlabel('gestational age', labelpad=10)
# plt.ylabel('Folding Power', labelpad=10)
...
# sns.lineplot(data=df, x='gestational_age', y='band_power_B4', label='B4', marker='o')
# sns.lineplot(data=df, x='gestational_age', y='band_power_B5', label='B5', marker='s')
# sns.lineplot(data=df, x='gestational_age', y='band_power_B6', label='B6', marker='^')

# # Customize the appearance
# plt.title('Band Power in relation to Gestational Age', pad=15, fontsize=14)
# plt.xlabel('Gestational Age', labelpad=10)
# plt.ylabel('Band Power', labelpad=10)
...
# plt.title('Gestational Age Across Subjects', fontsize=14, pad=15)
