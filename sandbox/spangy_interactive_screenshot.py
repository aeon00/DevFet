...
# # Example Usage
# directory = "/home/INT/dienye.h/python_files/rough/temp/mesh"
# tex_dir = '/home/INT/dienye.h/python_files/rough/temp/texture'
...
#         clean_filename = file.replace("segmented_smooth_5_spangy_dom_band_", "").replace('_gyri_and_sulci.gii', '')
...
#             combined = [-6, -5, -4, 4, 5, 6]
#             sulci = [-6, -5, -4]
#             fig = plot_mesh_with_legend(
#                 vertices=mesh.vertices,
#                 faces=mesh.faces,
#                 scalars=loc_dom_band_texture,
#                 selected_bands=combined,  # Will show only sulci bands 4, 5, 6
...
output_html_dir = Path('/home/INT/dienye.h/python_files/rough/temp/html_outputs')
...
for filename in os.listdir(directory):
    ...
    for file in os.listdir(tex_dir):
        ...
        if filename == clean_filename:
            ...
            html_filename = output_html_dir / f'{participant_session}_{hem_det}_interactive.html'
            fig.write_html(
                html_filename,
                config={
                    'toImageButtonOptions': {
            ...
            # Optional: Still show in browser (comment out if you don't want to display)
            # fig.show()

print(f"\nAll HTML files saved to: {output_html_dir}")