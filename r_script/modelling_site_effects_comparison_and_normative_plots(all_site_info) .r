...
# ============================================
# THREE TYPES OF NORMATIVE CURVE PLOTS
# ============================================
# Add this code within your loop after calculating test_quantiles
...
for (i in 1:nrow(best_models)) {
  ...
  # Prepare prediction data frames with the SAME variable names used during fitting
  ...
  # Prepare quantile data for plotting - only use training predictions for curves
  ...
  p1_color_dataset <- ggplot(combined_plot_data) +
    ...
    scale_color_manual(values = c("Training" = "blue", "Test" = "red"),
                      name = "Dataset") +
    scale_shape_manual(values = c("dHCP" = 17, "MarsFet" = 16),  # Triangle and circle
                      name = "Site") +
    scale_linetype_manual(values = quantile_linetypes,
  ...
  # ============================================
  # PLOT 2: All data same color (like original model plots)
  # ============================================
  ...
  # ============================================
  # PLOT 3: Curves only, no data points
  # ============================================
  ...
  filename1 <- paste0("/home/INT/dienye.h/gamlss_normative_paper-main/test/single_site/normative_curves/",
                     gsub(" ", "_", feature_name), "_plot1_colored_dataset.png")
  filename2 <- paste0("/home/INT/dienye.h/gamlss_normative_paper-main/test/single_site/normative_curves/",
                     gsub(" ", "_", feature_name), "_plot2_same_color.png")
  filename3 <- paste0("/home/INT/dienye.h/gamlss_normative_paper-main/test/single_site/normative_curves/",
                     gsub(" ", "_", feature_name), "_plot3_curves_only.png")
  ...
  filename_combined <- paste0("/home/INT/dienye.h/gamlss_normative_paper-main/test/single_site/normative_curves/",
